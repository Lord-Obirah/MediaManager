...
namespace MediaManager.Helpers
{
    ...
    {
        public static IOrderedQueryable<T> ApplySorting<T>(this DbSet<T> source, string orderBy,
            ...
            where T: class, IID
        {
            ...
            {
                return (IOrderedQueryable<T>)source.AsQueryable();
            }
            ...
            foreach (var orderByClause in orderByAfterSplit.Reverse())
            {
                ...
                foreach (var destinationProperty in propertyMappingValue.DestinationProperties.Reverse())
                {
                    ...
                    queryable = queryable.OrderBy(destinationProperty + (orderDescending ? " descending" : " ascending"));
                }
            }
